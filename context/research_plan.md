...
- Ground-truth sources (experimental, never software-predicted):
  ...
  **Rho-dependent terminators — 2-phylum in-vivo cross-genome panel (strengthened Jun 24 2026; was E. coli-only)**
  ...
  |---|---|---|---|---|
  | *E. coli* / Gammaproteobacteria | **Peters et al. 2012** (Genes Dev 26:2621, PMID 23207917, PMC3521622; GEO GSE41936/GSE41939) | RNA-seq + ChIP-chip, bicyclomycin (BCM) readthrough | ~1,000 (1,264 BSTs pulled) | T1 in vivo |
  ...
  | *M. tuberculosis* / Actinobacteria | **Botella et al. 2022/2023** (iScience, PMID 37096044, PMC10122055, DOI 10.1016/j.isci.2023.106465; ArrayExpress **E-MTAB-11753**) | Term-seq + **RhoDUC genetic Rho depletion** (Mtb Rho is BCM-resistant → orthogonal to E. coli) | **439** high-confidence RD-TTS pulled (mmc5: 299 True + 125 Cond + 15 SecCond; 802 at broader mmc4 threshold) | T1 in vivo |
  ...
  - **Cross-genome Rho is now real but modest:** E. coli ↔ *M. tuberculosis* = 2 phyla, 2 orthogonal in vivo methods (1,264 and 439 sites pulled). This supports leave-one-genome-out and a cross-phylum unseen test for Rho (previously impossible). *B. subtilis* H-SELEX adds a 3rd phylum but is **in vitro** → reported with the evidence-type caveat, not co-mingled with in vivo positives.
...
| **Rho-dependent terminators** | Curated DB `data/rho_database/`: Peters 2012 BCM + NAR 2018 Term-seq (E. coli in vivo), Botella 2022 RhoDUC depletion (MTB in vivo, E-MTAB-11753), B. subtilis H-SELEX (in vitro); TERMITe intrinsic decoy | E. coli 1,264 + MTB 439 in vivo (pulled); B. subtilis 4,789 in vitro | **Yes — modest:** 2-phylum in vivo (E. coli ↔ MTB, orthogonal methods) cross-genome + intra-genome ≤60%-identity splits |
