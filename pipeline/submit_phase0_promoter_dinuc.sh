#!/bin/bash
#SBATCH --job-name=phase0_prom_dinuc
...
#
# Confound-free promoter detection: within-class dinucleotide-shuffle feature extraction.
#   sbatch pipeline/submit_phase0_promoter_dinuc.sh
#
set -euo pipefail
