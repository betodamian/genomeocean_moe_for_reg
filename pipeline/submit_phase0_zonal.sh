...
#
# Phase-0 RBS SD zonal (per-position) feature extraction. Decisive dilution-vs-
# non-specialization test. Mirrors submit_phase0.sh.
#   sbatch pipeline/submit_phase0_zonal.sh
#
set -euo pipefail
